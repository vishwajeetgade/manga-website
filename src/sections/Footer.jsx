      ...
      <div className="flex justify-between items-start gap-20 flex-warp max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
            Get manga ready for the new term at your nearest Manga store. Find
            your favourite Manga. Get Rewards
          </p>
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-10 flex-wrap">
          {footerLinks.map((section) => (
            <div key={section.title}>
              <h4 className="text-white font-montserrat text-2xl leading-none font-medium mb-6">
                {section.title}
              </h4>
              <ul>
