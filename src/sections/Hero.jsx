    ...
    >
      ...
      >
        ...
        >
          ...
          <br />
          <span className="text-coral-red inline-block mt-3">Manga</span>
        </h1>
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">
          Manga are comics or graphic novels originating from Japan. Most manga
          conform to a style developed in Japan in the late 19th century.
        </p>
      ...
      bg-cover bg-primary bg-hero bg-center"
      >
        <img
          src={bigShoeImg}
          alt="big shoe image"
